...
@RestController
@RequestMapping("/productionefficiency/axisefficiency")
public class AxisEfficiencyController {
    private final Logger logger = LoggerFactory.getLogger(AxisEfficiencyController.class);
        ...
        try {
            return ActiveJdbc.operTx(new Operation<RequestResult<String>>() {
                ...
                public RequestResult<String> operate() {
                    ...
                    AxisEfficiency axisEfficiency = new AxisEfficiency();
    ...
    public RequestResult<Void> delete(@RequestBody final Object[] idList) {
        return ActiveJdbc.operTx(new Operation<RequestResult<Void>>() {
            ...
            public RequestResult<Void> operate() {
                int deleteAmount = AxisEfficiency.delete("machine_id IN (" + Util.strSplitBy("?", ",", idList.length) + ")", idList);
                return success();
            }
        });
    }
    ...
    public RequestResult<List<Map>> read() {
        return ActiveJdbc.oper(new Operation<RequestResult<List<Map>>>() {
            ...
            public RequestResult<List<Map>> operate() {
                return success(AxisEfficiency.findAll().toMaps());
            }
        });
    }
}
