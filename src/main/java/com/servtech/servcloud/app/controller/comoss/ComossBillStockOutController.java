...
@RestController
@RequestMapping("/comoss/billstockout")
public class ComossBillStockOutController {

    public static final Logger LOG = Logger.getLogger(ComossBillStockOutController.class);
        ...
        return ActiveJdbc.operTx(() -> {
            ...
            if (model.equals("tablet")) {
                if (billNo.equals(EMPTY)) {
                    BillNoPickUp.delete("sender_key = ?", userId);
