 ...
 */
@Table("a_servtrack_tracking_no_move_out")
@CompositePK({ "move_in", "line_id", "work_id", "op", "cust_field_1", "cust_field_2", "cust_field_3", "cust_field_4", "cust_field_5" })
@BelongsToParents({
...
public class WorkTrackingNoMoveOut extends Model {
}
