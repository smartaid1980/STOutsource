DROP TABLE IF EXISTS `a_cosmos_product`;
CREATE TABLE  `servcloud`.`a_cosmos_product` (
  `date` date NOT NULL,
  ...
  `std_hours` decimal(10,4) NOT NULL,
  `ng_quantity` int(10) NOT NULL,
  `create_by` varchar(50) NOT NULL,
  `create_time` datetime NOT NULL,
  `modify_by` varchar(50) NOT NULL,
  `modify_time` datetime NOT NULL,
  PRIMARY KEY (`date`,`work_shift`,`machine_id`)
...
DROP TABLE IF EXISTS `a_cosmos_program_production_by_shift`;
CREATE TABLE  `servcloud`.`a_cosmos_program_production_by_shift` (
  `date` date NOT NULL,
  `work_shift` varchar(10) NOT NULL,
  `machine_id` varchar(32) NOT NULL,
  `operator_id` varchar(50) NOT NULL,
  ...
  `cycle_time` int(10) NOT NULL,
  `ng_quantity` int(10) NOT NULL,
  `actual_output` int(10) NOT NULL,
  `create_by` varchar(50) NOT NULL,
  `create_time` datetime NOT NULL,
  `modify_by` varchar(50) NOT NULL,
  `modify_time` datetime NOT NULL,
  PRIMARY KEY (`date`,`work_shift`,`machine_id`,`operator_id`,`order_no`,`part_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
