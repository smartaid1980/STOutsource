...
INSERT INTO `m_sys_user` (`user_id`,`user_pwd`,`user_name`,`user_email`,`user_phone`,`user_address`,`pwd_error_count`,`is_valid`,`is_lock`,`is_close`,`create_time`,`create_by`,`modify_time`,`modify_by`,`language`) VALUES
 ('userunit','68c971184a2d8d84003598a640b1635b','userunit','','','',0,0,0,1,NOW(),'admin',NULL,NULL,'zh_tw'),
 ('adminunit','f80ef4b61dd49d31cbfc38759341a13d','adminunit','','','',0,0,0,1,NOW(),'admin',NULL,NULL,'zh_tw');
...
INSERT INTO `m_sys_group` (`group_id`,`group_name`,`create_time`,`create_by`,`modify_time`,`modify_by`,`is_close`) VALUES
 ('unit_user_group','ServUnit一般使用者群組',NOW(),'admin',NULL,NULL,0),
 ('unit_admin_group','ServUnit管理者群組',NOW(),'admin',NULL,NULL,0);
...
INSERT INTO `m_sys_user_group` (`user_id`,`group_id`,`create_time`,`create_by`,`modify_time`,`modify_by`) VALUES
 ('userunit','unit_user_group',NOW(),'admin',NULL,NULL),
 ('adminunit','unit_admin_group',NOW(),'admin',NULL,NULL);
...
INSERT INTO `m_sys_auth` (`auth_id`,`auth_name`,`is_open`,`create_time`,`create_by`,`modify_time`,`modify_by`,`is_close`) VALUES
 ('unit_user_auth','ServUnit使用者權限',0,NOW(),'admin',NULL,NULL,0),
 ('unit_admin_auth','ServUnit管理者權限',0,NOW(),'admin',NULL,NULL,0);
...
INSERT INTO `m_sys_group_auth` (`group_id`,`auth_id`,`create_time`,`create_by`,`modify_time`,`modify_by`) VALUES
 ('unit_user_group','unit_user_auth',NOW(),'admin',NULL,NULL),
 ('unit_admin_group','unit_user_auth',NOW(),'admin',NULL,NULL),
 ('unit_admin_group','unit_admin_auth',NOW(),'admin',NULL,NULL);
