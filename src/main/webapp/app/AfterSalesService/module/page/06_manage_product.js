    ...
    util: {
      initCustomerTable: function () {
        servkit.crudtable({
          ...
          create: {
            url: 'api/aftersalesservice/product/create',
          },
          read: {
            url: 'api/aftersalesservice/product/read',
          },
          update: {
            url: 'api/aftersalesservice/product/update',
          },
          delete: {
            url: 'api/aftersalesservice/product/delete',
          },
          excel: {
            url: '/api/aftersalesservice/product/excel',
          },
          validate: {
            1: function (td, table) {
