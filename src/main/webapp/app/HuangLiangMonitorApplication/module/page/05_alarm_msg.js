  ...
  ;(function () {
    var monitor = function () {
      var monitorCmd = {
        ...
        timeout: 0,
        items: [
          { signal: { id: 'G_ALAM' }, collect: { waitMs: 0, count: 1 } }, //機械座標
        ],
      }
      ...
      servkit.monitor({
        ...
        customCallback: function (data) {
          ...
          if (data['G_ALAM()']) {
            //data = {"G_ALAM()":{"type":"LONG","values":[[-1]]}};

            var alarmCode = data['G_ALAM()']
            var alarmCodeArray = alarmCode.values[0]
            ...
            servkit.monitor.tool({
              ...
              config: {
                ...
                callback: function (data) {
                  var matrix = []
                  _.each(alarmCodeArray, function (ele) {
