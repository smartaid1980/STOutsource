  ...
  ;(function () {
    var monitor = function () {
      var monitorCmd = {
        ...
        timeout: 0,
        items: [
          { signal: { id: 'G_SYSM' }, collect: { waitMs: 0, count: 1 } }, //機械座標
        ],
      }

      var tableHeadColumns = [
        { id: 'system1', name: `${i18n('System')}` },
        { id: 'name1', name: `${i18n('Name')}` },
        { id: 'id11', name: 'Id-1' },
        { id: 'id12', name: 'Id-2' },
        { id: 'system2', name: `${i18n('System')}` },
        { id: 'name2', name: `${i18n('Name')}` },
        { id: 'id21', name: 'Id-1' },
        { id: 'id22', name: 'Id-2' },
      ]
      ...
      servkit.monitor({
        ...
        customCallback: function (data) {
          ...
          if (data['G_SYSM()']) {
            ...
            var systemObj = { 'System Software': [], 'System Hardware': [] }
