...
export default function () {
  GoGoAppFun({
    gogo: function (ctx) {
      ...
      ctx.tables[1] = createReportTable({
        $tableElement: ctx.$dataTable1,
        $tableWidget: ctx.$dataTableWidget1,
        showNoData: true,
      })
      ctx.tables[2] = createReportTable({
        $tableElement: ctx.$dataTable2,
        $tableWidget: ctx.$dataTableWidget2,
        showNoData: true,
      })
      ctx.tables[3] = createReportTable({
        $tableElement: ctx.$dataTable3,
        $tableWidget: ctx.$dataTableWidget3,
        showNoData: true,
      })
      ctx.tables[4] = createReportTable({
        $tableElement: ctx.$dataTable4,
        $tableWidget: ctx.$dataTableWidget4,
        showNoData: true,
      })
    ...
    util: {
      ...
      $dataTableWidget3: $('#data-table-widget-3'),
      $dataTableWidget4: $('#data-table-widget-4'),
      $dataTable1: $('#data-table-1'),
      $dataTable2: $('#data-table-2'),
      $dataTable3: $('#data-table-3'),
      $dataTable4: $('#data-table-4'),
      $clear: $('#clearDB'),
      ...
      clearDB: function () {
        servkit.ajax(
          {
            url: 'api/servtracksimulator/clearBasicData',
            type: 'DELETE',
