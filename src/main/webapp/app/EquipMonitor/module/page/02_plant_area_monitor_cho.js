    ...
    gogo: function (context) {
      ...
      ;(function () {
          ...
          servkit.subscribe('DeviceStatus', {
            ...
            handler: function (data) {
              ...
              _.each(machinesMap, function (ele, key) {
                ...
                //客製化，當日產量
                currentTodayProducts[key] = ele['G_PSCP()'] || '---'
              })
              //demo假資料換燈號
          ...
          if (currentLights) {
            ...
            _.each(currentLights, function (ele) {
              ...
              if (!isTimeoutDeviceStatus(ele[machineIdIndex], ele[dateIndex])) {
                ...
                $plantAreaTd
                  .find('.todayProduct')
                  .html(currentTodayProducts[ele[machineIdIndex]])
                //TODO currentTodayProducts
              } else {
                $plantAreaTd
                  .find('.machineLight')
                ...
                $plantAreaTd.find('.todayProduct').html('---')
              }
            })
          } else {
          ...
          if (data.area != undefined) {
            ...
            _.each(data.area, function (record, rowKey) {
              ...
              _.each(record, function (col, colKey) {
                ...
                if (col != '' && rowKey != 0 && colKey != 0) {
                  ...
                  if (
                    ...
                    if (
                      ...
                      todayProduct = currentTodayProducts[machineId]
                    } else {
                ...
                if (todayProduct) {
                  $td.append(
                    '<span class="todayProduct" style="font-weight:bolder;color:blue;">' +
                      todayProduct +
                      '</span>'
                  )
                }
        ...
        function bindTarget2Monitor() {
          ...
          console.log(lang)
          var url = '#app/EquipMonitor/function/' + lang + '/01_info_cho.html'
          $('.machineLight')
            .off('click')
            .on('click', function () {
              var boxId
