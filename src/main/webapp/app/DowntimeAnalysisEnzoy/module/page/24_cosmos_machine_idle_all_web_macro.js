            ...
            },
            {
              success: function (shiftData) {
                ...
                var hippoInstans = hippo
                  .newSimpleExhaler()
                  .space('fah_product_work_web_macro')
                ...
                hippoInstans.exhale(function (exhalable) {
                  ...
                  for (var i = 0; i < exhalable.exhalable.length; ++i) {
                    ...
                    // 解析 macro
                    let tempObj = context.getMacroobj(
                  ...
                  let machineList = context.$stkReportForm
                    .find("[name='device']")
                    .val()
                  let selectSize = _.filter(machineList, (value) => {
                    return value !== 'ALL'
                  }).length
    ...
    util: {
      ...
      getMacroobj: function (macros, context) {
        ...
        if (macros.includes('alarm') || macros.includes('M')) {
          ...
          let macro = context.preCon.macro_json
