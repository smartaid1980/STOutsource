    ...
    while (curr !== 'EOF') {
        ...
        switch(curr.code) {
            ...
            case 10: // X coordinate of 'first alignment point'
                entity.startPointX = helpers.parsePoint(scanner);
                break;
            case 11: // X coordinate of 'second alignment point'
                entity.endPoint = helpers.parsePoint(scanner);
                break;
            case 20: // Y coordinate of 'first alignment point'
                entity.startPointY = helpers.parsePoint(scanner);
                break;
            case 30: // Z coordinate of 'first alignment point'
                entity.startPointZ = helpers.parsePoint(scanner);
                break;
            case 39:
